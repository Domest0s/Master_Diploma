...
%  			(opamp2.-) node[left ] {$v_-$};
	...
	В нашій наявності було джерело $Fe^{55}$  яке чудово підходить для калібровки дрейфової трубки. $Fe^{55}$ в нашому випадку виступає джерелом фотонів з майже моноенергетичним спектром з енергією 5.9 keV.
